# 218 API models: 165 Spec, 0 Request, 53 Write
...
class InternalHelpResourcesContent(model.Model):
    """
    Attributes:
        menu_item_text: Text to display in the help menu item which will display the internal help resources
        markdown_content: Content to be displayed in the internal help resources page/modal
        can: Operations the current user is able to perform on this object
    """

    menu_item_text: Optional[str] = None
...
class LookmlModelExploreField(model.Model):
    ...
    Attributes:
        ...
        user_attribute_filter_types: An array of user attribute types that are allowed to be used in filters on this field. Valid values are: "advanced_filter_string", "advanced_filter_number", "advanced_filter_datetime", "string", "number", "datetime", "yesno", "zipcode".
...
class ScheduledPlan(model.Model):
    ...
    Attributes:
        ...
        title: Title
        user_id: User Id which owns this ScheduledPlan
        user:
        run_as_recipient: Whether schedule is ran as recipient (only applicable for email recipients)
...
class SqlQueryCreate(model.Model):
    """
    Attributes:
        connection_id: Id of Connection (this or "model_name" required)
...
class WriteDashboardBase(model.Model):
    ...
    def __init__(self, *, space: Optional["WriteSpaceBase"] = None):
        self.space = space
